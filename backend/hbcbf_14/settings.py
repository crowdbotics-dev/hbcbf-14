"""
Django settings for hbcbf_14 project.
...
WSGI_APPLICATION = 'hbcbf_14.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hbcbf_14 API",
    "DESCRIPTION": "API documentation for hbcbf_14 App",
    "VERSION": "v1",
}
